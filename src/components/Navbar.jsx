function navbar() {
	return (
		<div id="main-navbar">
			<nav class="">
				<ul id="nav-icons" class="mt-0">
					<li id="logo-twitter" class="mt-2 mt-lg-0">
						<img src="../img/logoHome.svg" alt="" />
					</li>
					<a href="/">
						<li class="fs-6">
							<img src="../img/homeIcon.svg" alt="" />
							<span class="fs-6 d-md-none d-lg-inline-block">
								Home
							</span>
						</li>
					</a>
					...
					<li>
						...
						<span class="d-md-none d-lg-inline-block fs-6">
							Notifications
						</span>
					</li>
					<li>
					...
					<li>
						<a id="tweet-btn" class="btn text-white" href="/">
							Tweet
						</a>
					</li>
				</ul>
			...
			<a
				id="logout-btn"
				class="btn btn-danger rounded-pill mt-1 text-white"
				href="/logout"
			>
				Log Out
			</a>
