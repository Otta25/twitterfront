				...
				<ul id="nav-icons" className="mt-0 pt-0">
					...
					<Link to="/" className="text-decoration-none">
						<li className="fs-6">
							...
							<span className="fs-6 d-md-none d-xl-inline-block text-decoration-none">
								Home
							</span>
						</li>
					</Link>
					<li>
						...
						<span className="fs-6 d-md-none d-xl-inline-block">
							Explore
						</span>
					</li>
					<li>
						...
						<span className="d-md-none d-xl-inline-block fs-6">
							Notifications
						</span>
					</li>
					<li>
					...
					<li>
						...
						<span className="d-none d-xl-inline-block fs-6">
							Bookmarks
						</span>
					</li>
					<li>
